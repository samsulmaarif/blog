...
[runners.cache]
  ...
  [runners.cache.s3]
  [runners.cache.gcs]
    CredentialsFile = "/etc/gitlab-runner/gilab-sa.json"
...
[runners.machine]
  ...
  [[runners.machine.autoscaling]]  # Define periods with different settings
    Periods = ["* * 7-17 * * mon-fri *"] # Every workday between 7 and 17 WIT
    IdleCount = 0
    IdleTime = 600
...
![Izu Zero-One](https://wiki.tvnihon.com/w/images/a/a9/KRZeroOnecast03.png)

Eh, maaf salah paste gambar, maksudnya yang ini :

![Poster Training Intermediate GitLab CI](https://nacita.id/img/poster/intermediate-gitlab-ci.jpg)
